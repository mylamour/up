...
class MemoryManager:
    ...
    def __init__(self, workspace: Path | None = None, use_vectors: bool = True):
        ...
        self._git_context_time: datetime | None = None
    ...
    def search(self, query: str, limit: int = 5,
               ...
               branch: str | None = None) -> list[MemoryEntry]:
    ...
    def recall(self, topic: str, branch: str | None = None) -> str:
